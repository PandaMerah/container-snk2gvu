...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-snk2gvu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-snk2gvu.containers.anotherwebservice.com/
...
```
git clone git@github.com:PandaMerah/container-snk2gvu.git
cd container-snk2gvu
```
...
```
docker attach container-snk2gvu
```
